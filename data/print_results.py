...
def print_results(results_dic, results_stats_dic, model, 
    ...
    # classified as dogs or dogs misclassified as not-a-dog - print out these cases
    ...
    # If print_incorrect_breed is True AND there were dogs whose breeds were
    # misclassified - print out these cases
